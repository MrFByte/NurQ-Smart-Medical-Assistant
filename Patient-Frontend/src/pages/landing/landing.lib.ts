...
export const STATS = [
  { value: '50,000+', label: 'Patients served', color: 'text-blue-600' },
  { value: '3 min', label: 'Average intake time', color: 'text-cyan-600' },
  { value: '24/7', label: 'Available 24/7', color: 'text-teal-600' },
  { value: '99.8%', label: 'Care accuracy', color: 'text-emerald-600' },
];

export const FEATURES = [
  { title: 'Intelligent triage', desc: 'Our system listens to your symptoms and identifies urgency in real-time.' },
  { title: 'Safe & private', desc: 'Your data is encrypted end-to-end. Nothing is shared without consent.' },
  { title: 'Save time', desc: 'Skip the paperwork. Get your appointment token in under 3 minutes.' },
];
